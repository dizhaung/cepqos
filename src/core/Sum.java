...
public class Sum extends Aggregate{
    ...
    /**
     * compute the aggregated value (the sum in this case) of the specified attribute over the specified array of events 
     * @param evts
     * @return an eventbean with a unique attribute carrying the aggregated value.
     */
    @Override
